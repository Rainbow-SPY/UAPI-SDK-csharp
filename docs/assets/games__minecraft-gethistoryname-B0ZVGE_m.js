const t={slug:"games/minecraft-gethistoryname",html:`<h1 id="获取-minecraft-玩家历史昵称">获取 Minecraft 玩家历史昵称</h1>
<div class="gfm-alert gfm-alert-note"><div class="gfm-alert-title">Note</div><div class="gfm-alert-body"><p>所有 Minecraft 相关被请求查询的用户必须均为正版, 否则没有官方数据会返回 <code>404</code>等<code>StatusCode</code> .所有 Minecraft 相关被请求查询的用户必须均为正版, 否则没有官方数据会返回 <code>404</code>等<code>StatusCode</code> .</p>
