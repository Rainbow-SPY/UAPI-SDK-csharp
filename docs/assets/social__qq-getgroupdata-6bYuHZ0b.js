const t={slug:"social/qq-getgroupdata",html:`<h1 id="获取qq群相关信息">获取QQ群相关信息</h1>
<h2 id="请求示例">请求示例</h2>
...
<h2 id="属性列表">属性列表</h2>
<h3 id="根属性">根属性</h3>
<div class="gfm-alert gfm-alert-warning"><div class="gfm-alert-title"><span class="gfm-alert-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m10.29 3.86-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.71-3.14l-8-14a2 2 0 0 0-3.42 0z"></path><path d="M12 9v4"></path><path d="M12 17h.01"></path></svg></span><span>Warning</span></div><div class="gfm-alert-body"><p>标记为 <code>(可选)</code> 的项可为 <code>null</code> 或 <code>string.Empty</code> 空字符串,这代表您在处理接受的 <code>Json</code> 对象时要注意 <code>null</code> 判定标记为 <code>(可选)</code> 的项可为 <code>null</code> 或 <code>string.Empty</code> 空字符串,这代表您在处理接受的 <code>Json</code> 对象时要注意 <code>null</code> 判定</p>
</div></div><table>
<thead>
<tr>
