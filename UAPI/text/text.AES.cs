...
namespace UAPI
{
    ...
    public class AES
    {
        ...
        public static async Task<Type.AESEncryptType> Encrypt(string _key, string _text, string Authentication = "")
        {
            ...
            var list = Interface.IsGetSuccessful(result, "key or text", statuscode, new General.UAPIUnknowException(),
                "AES.Encrypt");
        ...
        public static async Task<string> ReturnEncryptedText(string _key, string _text, string Authentication = "") =>
